                ...
                <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        <div className="writer">
                            <h1 className="title-font writer-text sm:text-4xl text-3xl mb-4 font-medium text-gray-900">Fenil Soanni</h1>
                        </div>
                        <div className="writer">
                            <h1 className='title-font writer-text sm:text-4xl text-3xl mb-4 font-medium text-gray-900'>Software Developer</h1>
                        </div>
