...
const contact = () => {
    function grayscale(arg0: number): import("csstype").Property.Filter | undefined {
            ...
            <section className="text-gray-600 body-font relative">
                <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                    <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                        <iframe width="100%" height="100%" className="absolute grayscale-[50] contrast-[1.2] blur-[2px] inset-0" frameBorder={0} title="map" src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d14873.311390726325!2d72.83973144999999!3d21.25848635!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1674989592064!5m2!1sen!2sin" style={{}}></iframe>
                        ...
                        <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md w-full">
                            <div className="lg:w-1/2 px-6">
                                ...
                                <p className="mt-1">Surat,Gujarat,India</p>
                            </div>
